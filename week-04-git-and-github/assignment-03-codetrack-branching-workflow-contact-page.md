...
![Task 1 Clean Status](screenshots/task1-clean-status.png)
...
![Task 2 Feature Branch](screenshots/task2-feature-branch.png)
...
![Task 3 LS Contact](./screenshots/task3-ls-contact.png)

---

#### Screenshot 4 — Output of `git commit`

![Task 4 Commit Output](./screenshots/task4-commit-output.png)
---

#### Screenshot 5 — Output of `git log --oneline -3` showing the new commit

![Task 5 Isolation Check](./screenshots/task5-isolation-check.png)
...
![Task 6 Merge Output](./screenshots/task6-merge-output.png)

![Task 6 LS Merged](./screenshots/task6-ls-merged.png)

#### Screenshot 7 — Output of `git commit`

![Task 7 Git Graph](./screenshots/task7-git-graph.png)

---

#### Screenshot 8 — Browser showing the Contact Page link on the homepage while on `feature/contact-page`

![Task 8 Branch Deleted](./screenshots/task8-branch-deleted.png)
...
![Task 14 Branch Deleted](./screenshots/task8-branch-deleted.png)
